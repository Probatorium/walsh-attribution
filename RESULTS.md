...
observed share at order 2 is above its family mean and sits at the 95.966th
percentile of the family. The observed share at order 4 is slightly below its
family mean and sits at the 46.605th percentile, which is an ordinary place
for it to be. A statistic that adds the two carries one order that is far up
its family and one that is where the family puts it.
